...
import 'dart:async';
import 'package:good_citizen/app/core/values/app_strings.dart';
import 'package:good_citizen/app/core/values/app_values.dart';
import 'package:good_citizen/app/core/widgets/asset_image.dart';
import 'package:good_citizen/app/core/widgets/asset_svg.dart';
        ...
        children: [
          Container(
              decoration: BoxDecoration(
                 border: Border(bottom: BorderSide(color:  Color.fromRGBO(204,204,204, 1))),
                  ),
              child: _buildFlagsButton()
                  .paddingSymmetric(horizontal: margin_3, vertical: margin_15)),
          SizedBox(width: margin_7),
          Expanded(
            child: TextFormField(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  ...
                  //     ?
                  AssetImageWidget(
                    'lib/app/core/widgets/intl_phone_field/assets/flags/${widget.initialSelectedCountry.value.code.toLowerCase()}.png',
                ...
                FittedBox(
                  child: Text(
                    '+${widget.initialSelectedCountry.value.dialCode}',
                ...
                if (widget.enabled &&
                  ...
                  const SizedBox(width: 2),
                  AssetSVGWidget(icDropDown,color: isDarkMode.value
                      ? Colors.white
                      : AppColors.blackColor,
                          imageWidth: height_6, imageHeight: height_6)
