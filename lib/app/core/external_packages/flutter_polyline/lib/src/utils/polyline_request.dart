...
class PolylineRequest {
  ...
  Map<String, dynamic> getParams() {
    var params = removeNulls({
      ...
      "travelMode": 'DRIVE', // Ensure it's in uppercase as required
      "routingPreference": "TRAFFIC_AWARE", // Adjust as needed
      "computeAlternativeRoutes": alternatives, // Assuming alternatives is a boolean
      "routeModifiers": {
