...
import 'package:good_citizen/app/core/external_packages/another_stepper.dart/widgets/vertical_stepper.dart';
...
class AnotherStepper extends StatelessWidget {
  ...
  const AnotherStepper({
    ...
    this.inverted = false,
    this.activeBarColor = AppColors.appColor,
    this.inActiveBarColor = AppColors.appColor,
    this.barThickness = 2,
    this.scrollPhysics,
    this.iconHeight = 20,
    this.iconWidth = 20,
